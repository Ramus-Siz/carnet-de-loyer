  ...
  return (
    <>
      ...
      {isTrueToAddData && user === "une maison" ? (
        <div className="h-screen w-[40%] bg-[#E3EBF3] absolute  top-0 right-0 ease-in duration-500 z-40">
          <AddHouses HandleAddHouses={HandleAddData} />
        </div>
      ) : (
        <div className="h-screen w-[40%] bg-[#E3EBF3] fixed  top-0 right-0 ease-in duration-500 translate-x-full z-40">
          <AddHouses HandleAddHouses={HandleAddData} />
        </div>
      )}
